...
int main (int argc, char *argv[])
{
    ...
    bd = (fabs(res_bd)/fabs(res_s)+fabs(res2_bd)/fabs(res_s))/(fabs(res)/fabs(res_s)+fabs(res_x)/fabs(res_s)+fabs(res_xd)/fabs(res_sd)+fabs(res2)/fabs(res_s));
    ms = (fabs(res_ms)/fabs(res_s)+fabs(res2_ms)/fabs(res_s))/(fabs(res)/fabs(res_s)+fabs(res_x)/fabs(res_s)+fabs(res_xd)/fabs(res_sd)+fabs(res2)/fabs(res_s));
    wd = (fabs(res_wd)/fabs(res_s)+fabs(res2_wd)/fabs(res_s))/(fabs(res)/fabs(res_s)+fabs(res_x)/fabs(res_s)+fabs(res_xd)/fabs(res_sd)+fabs(res2)/fabs(res_s));
    bh = (fabs(res_bh)/fabs(res_s)+fabs(res2_bh)/fabs(res_s))/(fabs(res)/fabs(res_s)+fabs(res_x)/fabs(res_s)+fabs(res_xd)/fabs(res_sd)+fabs(res2)/fabs(res_s));
