...
double g1 (double *k, size_t dim, void *params)
{
    ...
    vszfunc=(1.0/(pow(2.0*3.1415926,0.5)*sigma_vsz))*exp(-0.5*(vsz*vsz)/(sigma_vsz*sigma_vsz));
        ...
        F=2.77*pow(10.0,-8.0)*(1.0/(k[0]*k[0]*k[0]*k[0]))*cos(b)*pnum*exp(-rds)*p_disk*(Deff)*(pow(M,0.5)*mfunc)*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0)/4.3656;
...
double g2 (double *k, size_t dim, void *params)
{
    ...
    vszfunc=(1.0/(pow(2.0*3.1415926,0.5)*sigma_vsz))*exp(-0.5*(vsz*vsz)/(sigma_vsz*sigma_vsz));
        ...
        F=2.77*pow(10.0,-8.0)*(1.0/(k[0]*k[0]*k[0]*k[0]))*cos(b)*pnum*exp(-rds)*pnum2*exp(-rds2)*(Deff)*(pow(M,0.5)*mfunc)*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0)/4.3656;
...
{   
    ...
    vszfunc=(1.0/(pow(2.0*3.1415926,0.5)*sigma_vsz))*exp(-0.5*(vsz*vsz)/(sigma_vsz*sigma_vsz));
        ...
        F=2.77*pow(10.0,-8.0)*(1.0/(k[0]*k[0]*k[0]*k[0]))*cos(b)*pnum*exp(-rds)*p_pulsar*(Deff)*(pow(M,0.5))*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0);
