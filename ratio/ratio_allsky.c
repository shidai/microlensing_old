...
int main (int argc, char *argv[])
{
    ...
    double xl[11]={3.0,0.0,0.03,-100.0,-150.0,-100.0,-550.0,-450.0,-350.0,0.0,-3.1415926/2.0};
    ...
    double xl2[11]={3.0,3.0,0.03,-550.0,-450.0,-350.0,-550.0,-450.0,-350.0,0.0,-3.1415926/2.0};
    ...
    double xl_x[10]={3.0,0.0,-2000.0,-2000.0,-2000.0,-550.0,-450.0,-350.0,0.0,-3.1415926/2.0};
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        galaxy = fabs(res)/fabs(res_s)+fabs(res2)/fabs(res_s);
        ratio = ns/(ns+galaxy);
        printf ("%e %e\n", t, ratio);
        fflush(stdout);        
