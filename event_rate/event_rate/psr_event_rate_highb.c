// calculate event rate towards high b
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
...
int main (int argc, char *argv[])
{
    ...
    double xl_s[3]={4.5,0.0,10.0*3.1415926/180.0};
    ...
    double xl_x[10]={4.5,0.01,-2000.0,-2000.0,-2000.0,-550.0,-450.0,-350.0,0.0,10.0*3.1415926/180.0};
    ...
    double xl_sd[3]={0.0,0.0,10.0*3.1415926/180.0};
    ...
    //double xl_x[4]={3.0,0.0,-1200.0,-1200.0};
    //double xu_x[4]={13.0,13.0,1200.0,1200.0};
    double xl_xd[10]={0.0,0.01,-2000.0,-2000.0,-2000.0,-100.0,-150.0,-100.0,0.0,10.0*3.1415926/180.0};
