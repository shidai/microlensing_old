...
{   
    ...
    //F=2.77*pow(10.0,-8.0)*k[0]*cos(b)*pnum*exp(-rds)*p_pulsar*(Deff)*(pow(M,0.5))*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0);
...
{   
    ...
    F=2.77*pow(10.0,-8.0)*(1.0/(k[0]*k[0]))*cos(b)*p_disk*p_pulsar*(Deff)*(pow(M,0.5))*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0);
    //F=2.77*pow(10.0,-8.0)*k[0]*cos(b)*p_disk*p_pulsar*(Deff)*(pow(M,0.5))*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0);
...
int main (int argc, char *argv[])
{
    ...
    double xl_sd[3]={0.1,0.0,-3.1415926/2.0};
    ...
    //double xl_x[4]={3.0,0.0,-1200.0,-1200.0};
    //double xu_x[4]={13.0,13.0,1200.0,1200.0};
    double xl_xd[10]={0.1,0.01,-2000.0,-2000.0,-2000.0,-100.0,-150.0,-100.0,0.0,-3.1415926/2.0};
